This program takes an input from the user, checks the given dataset of documents and retrieves the relevant paragraph/passage that the query is contained in. 
